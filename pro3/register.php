            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Accepts Date"
                               required pattern="0?[0-9]|[1-2][0-9]|3[0-1]">
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_password" name="c_password" placeholder="Accepts Year" required pattern="19[5-9][0-9]|200[0-1]">
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
